...
This preview is ad-hoc signed and not notarized. macOS cannot verify the developer identity, so Gatekeeper will block first launch until you approve it manually in System Settings. See [INSTALL.md](INSTALL.md) before opening the app.

## Scope and independence

This repository distributes public downloads and user documentation only. The main CovePilot source repository remains private during the technical preview. CovePilot is independent software and is not affiliated with Apple, OpenAI, GitHub, MusicBrainz, Cover Art Archive or Open-Meteo.
