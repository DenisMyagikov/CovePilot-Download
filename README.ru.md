...
CovePilot — независимый local-first технический preview для macOS: компактный остров рядом с физической чёлкой MacBook и Кови, маленький спутник, который показывает полезный локальный контекст без перегрузки menu bar.
